...
def download_ckpt(outdir='data/vibe_data', use_3dpw=False,use_mymodel=False):
    os.makedirs(outdir, exist_ok=True)
    if use_mymodel:
        ckpt_file = 'results/vibe_tests/best_para_addedloss/model_best.pth.tar'#my checkpoint
