...
class AMASS(Dataset):
    ...
    # def load_db(self):
    #     db_file = osp.join(VIBE_DB_DIR, 'amass_db.h5`')
    #     # db_file = osp.join(VIBE_DB_DIR, '3dpw_val_db.pt')
