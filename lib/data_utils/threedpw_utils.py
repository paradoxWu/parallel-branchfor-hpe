...
def read_data(folder, set, debug=False):
    ...
    backbone = get_cls_net(hrnet_config, pretrained=hrnet_checkpoint).to('cuda')
    ...
    for i, seq in tqdm(enumerate(sequences)):
        ...
        for p_id in range(num_people):
            ...
            features = extract_features(backbone, img_paths_array, bbox,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir', type=str, help='dataset directory', default='/home/wuyuanhao/dataset/3dpw')
