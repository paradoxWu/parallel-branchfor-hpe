...
class VIBELoss(nn.Module):
    ...
    def forward(
        ...
        ##from lifting
        pred_j3d_from_2d = preds['kp_3d_2d'][sample_2d_count:]
        ##
        ...
        ##from lifting
        pred_j3d_from_2d = reduce(pred_j3d_from_2d)
        ##
        w_3d = flatten(w_3d)
        ...
        loss_kp_3d = self.keypoint_3d_loss(pred_j3d, real_3d) + self.keypoint_3d_loss(pred_j3d_from_2d, real_3d)
